...
class IndexSync:
    def __init__(self):
        ...
        self.mysql_username = env("MYSQL_USER")
        self.mysql_password = env("MYSQL_PW")
        self.mysql_DBname = env("MYSQL_DB")
        self.mysql_port = 3306
        self.mongo_host = env("MONGO_HOST")
        self.mongo_port = 27017
        self.mongo_DBname = env("MONGO_DB")
        self.mongo_collname = env("MONGO_COLL")
