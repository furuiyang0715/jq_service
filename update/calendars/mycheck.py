...
def check():
    ...
    codes = [
        'SH600610', 'SH600145', 'SH600680', 'SZ300655', 'SZ300108', 'SZ002680', 'SZ002260', 'SH600074', 'SZ000029',
       'SZ000939', 'SZ002450', 'SZ300028', 'SZ300216', 'SH603015', 'SZ002604', 'SZ300104', 'SH600893', 'SZ000995',
       'SH603603', 'SZ000022', 'SZ002323'
    ]
...
"""
select IfTradingDay from const_tradingday where Date = '2019-05-08 00:00:00' 
and CMFTime = (select max(CMFTime) from const_tradingday where Date = '2019-05-08 00:00:00');


select id, (NoticeEndDate-NoticeStartDate), NoticeStartDate, NoticeEndDate from stk_specialnotice_new 
where SecuCode =000333  and NoticeTypei = 18 and NoticeTypeii != 1703;  

SELECT A.InnerCode,A.SecuCode,A.ListedDate,B.ChangeDate,B.ChangeType from stk_liststatus B,const_secumainall A 
WHERE A.InnerCode=B.InnerCode AND A.SecuMarket IN(83,90) AND A.SecuCategory=1 
AND  B.ChangeType IN(1,2,3,4,5,6) AND A.SecuCode = 000333; 
"""
